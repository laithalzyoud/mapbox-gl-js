...
import rasterFragImage from './raster.fragment.image.glsl';
import rasterVert from './raster.vertex.glsl';
import rasterVertImage from './raster.vertex.image.glsl';
...
export const rasterimage = compile(rasterFragImage, rasterVertImage);
